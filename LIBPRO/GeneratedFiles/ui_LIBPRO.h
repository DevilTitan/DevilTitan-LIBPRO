...
""));
        ...
        horizontalLayout->setContentsMargins(50, 10, 50, -1);
...
"}"));
        ...
        loginButton->setStyleSheet(QLatin1String("font: 10pt\"Segoe UI\";\n"
"font-weight:600;"));
        ...
        signUpButton->setStyleSheet(QLatin1String("font: 10pt\"Segoe UI\";\n"
"font-weight:600;"));
