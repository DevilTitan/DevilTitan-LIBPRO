...
""));
        ...
        label->setGeometry(QRect(70, 110, 151, 31));
        label->setStyleSheet(QStringLiteral(""));
        label->setPixmap(QPixmap(QString::fromUtf8(":/icon/Resources/icon/19369168_1053806048084597_838313858_o.png")));
        label->setScaledContents(true);
        label_2 = new QLabel(frame);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(70, 140, 161, 31));
...
"border-radius: 2px;"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icon/Resources/icon/padlock (1).png"), QSize(), QIcon::Normal, QIcon::Off);
...
"border: 2px solid #c02f1d"));
        ...
        plainTextEdit->setGeometry(QRect(580, 280, 171, 551));
        plainTextEdit->setStyleSheet(QLatin1String("background-color: transparent;\n"
"font: 20pt \"Lucida Sans Unicode\";\n"
"border: 0;\n"
"color: white;\n"
"font-size: 14px;\n"
"font-style:italic;"));
...
"font: 25 40pt \"Segoe UI Light\";"));
    ...
    {
        LoginForm->setWindowTitle(QApplication::translate("LoginForm", "LIBPRO", Q_NULLPTR));
        ...
        plainTextEdit->setPlainText(QApplication::translate("LoginForm", "There are no short ways to become successful. Learn from failure, learn with passion, work really hard, and you'll be the person you want to become", Q_NULLPTR));
