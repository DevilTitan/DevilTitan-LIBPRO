...
"}"));
        ...
        frame->setGeometry(QRect(10, 20, 831, 81));
...
"}"));
        ...
        layoutWidget->setGeometry(QRect(0, 0, 831, 76));
...
""));
        ...
        frame_2->setGeometry(QRect(10, 110, 831, 81));
...
"}"));
        ...
        layoutWidget1->setGeometry(QRect(0, 0, 831, 86));
...
"}"));
        ...
        sendButton->setGeometry(QRect(560, 490, 141, 61));
        sendButton->setStyleSheet(QStringLiteral("border-radius:5px;"));
        cancelButton = new QPushButton(sendNotification);
        cancelButton->setObjectName(QStringLiteral("cancelButton"));
        cancelButton->setGeometry(QRect(710, 490, 130, 61));
        cancelButton->setMinimumSize(QSize(130, 0));
        cancelButton->setStyleSheet(QStringLiteral("border-radius:5px;"));
    ...
    {
        sendNotification->setWindowTitle(QApplication::translate("sendNotification", "Send your message", Q_NULLPTR));
        label->setText(QApplication::translate("sendNotification", "   To whom would you want to send message?(separate with space(s))", Q_NULLPTR));
