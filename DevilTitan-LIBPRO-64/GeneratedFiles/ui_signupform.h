...
public:
    ...
    void setupUi(QDialog *signupForm)
    {
        ...
        signupForm->setStyleSheet(QLatin1String("QLineEdit{font-family: \"Ubuntu Light\"; font-size: 15px; background-color: white; color:#422b25}\n"
"QLabel{font-family: \"Ubuntu Light\"; color: white;}\n"
"QFrame{background-color:rgba(39,62,46, 0.2); border-radius: 3px;\n"
"}"));
...
""));
        accountName = new QLineEdit(frame);
        accountName->setObjectName(QStringLiteral("accountName"));
        accountName->setGeometry(QRect(20, 270, 321, 31));
        accountName->setStyleSheet(QLatin1String("border-top: 1px solid rgb(250, 250, 250);\n"
...
""));
        ...
        frame_2->setStyleSheet(QStringLiteral("background-color:rgba(39,62,46, 1)"));
...
"background-color:rgba(39,62,46, 1)\n"
"}\n"
"#login\n"
"{\n"
"border-radius: 2px;\n"
"\n"
"	background-color: rgb(66, 162, 97);\n"
"font-family:\"Ubuntu Light\";\n"
"font-size: 15px;\n"
"color: white;\n"
"}\n"
"#login:hover\n"
"{\n"
"background-color: rgb(37, 103, 55);\n"
"}"));
        frame_3->setFrameShape(QFrame::StyledPanel);
        frame_3->setFrameShadow(QFrame::Raised);
        label_9 = new QLabel(frame_3);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setGeometry(QRect(30, 5, 181, 31));
...
"font-family: \"Ubuntu Light\""));
        ...
        label_4->setGeometry(QRect(260, 270, 81, 31));
        label_4->setStyleSheet(QLatin1String("border: 2px solid rgb(235, 76, 75);\n"
"font-size: 10px;\n"
"background-color: white;\n"
"border-radius: 4px;\n"
"color: red;\n"
"font-family: \"Ubuntu Light\""));
        ...
        label_12->setGeometry(QRect(260, 340, 81, 31));
        label_12->setStyleSheet(QLatin1String("border: 2px solid rgb(235, 76, 75);\n"
"font-size: 10px;\n"
"border-radius: 4px;\n"
"color: red;\n"
"font-family: \"Ubuntu Light\";\n"
...
""));
        ...
        QWidget::setTabOrder(email, accountName);
        QWidget::setTabOrder(accountName, password);
    ...
    {
        signupForm->setWindowTitle(QApplication::translate("signupForm", "Create your account", Q_NULLPTR));
        ...
        label_4->setText(QApplication::translate("signupForm", "greater than 5", Q_NULLPTR));
        label_12->setText(QApplication::translate("signupForm", "greater than 5", Q_NULLPTR));
    } // retranslateUi
