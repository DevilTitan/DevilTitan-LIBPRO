...
public:
    ...
    void setupUi(QDialog *RequestBook)
    {
        ...
        RequestBook->setWindowIcon(icon);
...
"border-radius: 2px;"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/icon/Resources/icon/open-book.png"), QSize(), QIcon::Normal, QIcon::Off);
        btn1->setIcon(icon1);
...
"border-radius: 2px;"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icon/Resources/icon/house.png"), QSize(), QIcon::Normal, QIcon::Off);
        btn2->setIcon(icon2);
...
"border-radius: 2px;"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/icon/Resources/icon/quill.png"), QSize(), QIcon::Normal, QIcon::Off);
        btn3->setIcon(icon3);
...
"color:white;"));
    ...
    {
        RequestBook->setWindowTitle(QApplication::translate("RequestBook", "Request your book", Q_NULLPTR));
