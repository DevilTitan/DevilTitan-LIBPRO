...
public:
    ...
    void setupUi(QDialog *AccountStatistic)
    {
        ...
        AccountStatistic->setWindowIcon(icon);
...
"color:rgb(55,55,55)"));
        ...
        frame_2->setStyleSheet(QLatin1String("background-color: rgba(8, 48, 69, 0.9);\n"
...
"border-radius: 2px;"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/icon/Resources/icon/19073730_1922262664698614_862710217_n.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"border-radius: 2px;"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icon/Resources/icon/19113043_1922262658031948_1030609975_n.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"border-radius: 2px;"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/icon/Resources/icon/19073774_1922262661365281_2146484065_n.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"border-radius: 2px;"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/icon/Resources/icon/19073874_1922262651365282_1694282943_n.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"border-radius: 2px;"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/icon/Resources/icon/phone-call.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        label_11->setStyleSheet(QLatin1String("background-color: rgba(8, 48, 69, 0.9);border-bottom-right-radius: 3px;\n"
...
"font-familu:Roboto;"));
        ...
        label_13->setStyleSheet(QLatin1String("background-color: rgba(8, 48, 69, 0.9);border-bottom-right-radius: 3px;\n"
"border-bottom-left-radius: 3px;"));
...
"font-family:Roboto;"));
    ...
    {
        AccountStatistic->setWindowTitle(QApplication::translate("AccountStatistic", "Statistic", Q_NULLPTR));
