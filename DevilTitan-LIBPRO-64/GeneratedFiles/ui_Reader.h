...
"background: qradialgradient(cx: 0.3, cy: -0.4,\n"
"fx: 0.3, fy: -0.4,\n"
"radius: 1.35, stop: 0 rgb(241, 243, 244), stop: 1 #e5efff);\n"
"border-radius: 7px;\n"
"}\n"
"#removebtn:hover {\n"
"background: qradialgradient(cx: 0.3, cy: -0.4,\n"
...
"border-radius:0px;}\n"
"QLabel { font-family: \"Ubuntu Light\"; font-weight:500;\n"
"color:white;\n"
...
"font-size: 13px;};"));
        ...
        Usernamelbl_4->setStyleSheet(QStringLiteral(""));
        ...
        addbtn->setMinimumSize(QSize(90, 0));
        addbtn->setStyleSheet(QLatin1String("border: 0px;\n"
"border-radius:4px;\n"
"border-bottom-right-radius:0px;\n"
"border-top-right-radius:0;"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/icon/Resources/icon/cart(4).png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        Usernamelbl_7->setGeometry(QRect(1030, 500, 81, 41));
        Usernamelbl_7->setStyleSheet(QStringLiteral(""));
        ...
        Usernamelbl_2->setStyleSheet(QStringLiteral(""));
        removebtn = new QPushButton(frame);
        removebtn->setObjectName(QStringLiteral("removebtn"));
        removebtn->setGeometry(QRect(990, 440, 91, 61));
        removebtn->setMinimumSize(QSize(90, 0));
        removebtn->setStyleSheet(QLatin1String("border: 0px;\n"
"border-radius:4px;\n"
"border-bottom-left-radius:0px;\n"
"border-top-left-radius:0;"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icon/Resources/icon/cart (2).png"), QSize(), QIcon::Normal, QIcon::Off);
...
"padding:5px;"));
        ...
        Usernamelbl_3->setStyleSheet(QStringLiteral(""));
        Usernamelbl_6 = new QLabel(frame);
        Usernamelbl_6->setObjectName(QStringLiteral("Usernamelbl_6"));
        Usernamelbl_6->setGeometry(QRect(800, 500, 91, 41));
        Usernamelbl_6->setStyleSheet(QStringLiteral(""));
...
"border-radius: 5px;background-color: rgba(255, 255, 255, .4);alternate-background-color:rgba(159, 173, 201,0.2);selection-background-color:red;"));
        ...
        Usernamelbl_5->setStyleSheet(QStringLiteral(""));
...
"border-radius: 5px;background-color: rgba(255, 255, 255, .7);}"));
        ...
        description->setGeometry(QRect(20, 130, 331, 251));
        description->setLayoutDirection(Qt::LeftToRight);
        description->setStyleSheet(QLatin1String("color: black;\n"
"font-size: 14px;\n"
...
"margin: 8"));
        ...
        label_7->setStyleSheet(QLatin1String("color: rgb(55, 55, 55);\n"
"font-size: 13px;"));
        ...
        label_4->setStyleSheet(QLatin1String("color: rgb(55, 55, 55);\n"
"font-size: 13px;"));
...
"margin: 8"));
        ...
        label_6->setStyleSheet(QLatin1String("color: rgb(55, 55, 55);\n"
"font-size: 13px;"));
        rating2 = new QLabel(horizontalWidget_3);
        rating2->setObjectName(QStringLiteral("rating2"));
        rating2->setGeometry(QRect(190, 60, 71, 31));
        sizePolicy2.setHeightForWidth(rating2->sizePolicy().hasHeightForWidth());
        rating2->setSizePolicy(sizePolicy2);
        rating2->setStyleSheet(QLatin1String("color: rgb(55, 55, 55);\n"
"font-size: 13px;"));
...
"margin: 8"));
        ...
        label_2->setGeometry(QRect(730, 450, 51, 51));
...
""));
        ...
        borrowBook->setGeometry(QRect(730, 530, 361, 141));
...
"}"));
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/icon/Resources/icon/open-book (1).png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        publicChat->setStyleSheet(QStringLiteral(""));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/icon/Resources/icon/books (1).png"), QSize(), QIcon::Normal, QIcon::Off);
        publicChat->setIcon(icon4);
        ...
        publicChat_4->setStyleSheet(QStringLiteral(""));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/icon/Resources/icon/line-chart.png"), QSize(), QIcon::Normal, QIcon::Off);
        publicChat_4->setIcon(icon5);
        ...
        rate->setStyleSheet(QStringLiteral(""));
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/icon/Resources/icon/starr.png"), QSize(), QIcon::Normal, QIcon::Off);
        rate->setIcon(icon8);
        ...
        requestbtn->setStyleSheet(QStringLiteral(""));
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/icon/Resources/icon/6969.png"), QSize(), QIcon::Normal, QIcon::Off);
        requestbtn->setIcon(icon9);
...
""));
        ...
        bookListbtn->setStyleSheet(QStringLiteral(""));
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/icon/Resources/icon/order.png"), QSize(), QIcon::Normal, QIcon::Off);
        bookListbtn->setIcon(icon10);
        bookListbtn->setIconSize(QSize(40, 50));
...
"color:white;background-color:transparent;"));
        ...
        rolebtn->setStyleSheet(QStringLiteral(""));
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/icon/Resources/icon/shuffle (1).png"), QSize(), QIcon::Normal, QIcon::Off);
        rolebtn->setIcon(icon11);
        ...
        accountbtn->setStyleSheet(QStringLiteral(""));
        QIcon icon12;
        icon12.addFile(QStringLiteral(":/icon/Resources/icon/earth-globe.png"), QSize(), QIcon::Normal, QIcon::Off);
        accountbtn->setIcon(icon12);
        ...
        QIcon icon13;
        icon13.addFile(QStringLiteral(":/icon/Resources/icon/logout (10).png"), QSize(), QIcon::Normal, QIcon::Off);
        logout->setIcon(icon13);
...
"border-radius:50px;"));
        QIcon icon14;
        icon14.addFile(QStringLiteral(":/barIcon/Resources/icon/user (1).png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        notify->setGeometry(QRect(40, 430, 20, 20));
...
"", Q_NULLPTR));
        ...
        accountbtn->setText(QApplication::translate("Reader", "Inbox", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
