...
""));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/icon/Resources/icon/trash-2-512.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"color:white;"));
    ...
    {
        QueueBook->setWindowTitle(QApplication::translate("QueueBook", "In queue", Q_NULLPTR));
