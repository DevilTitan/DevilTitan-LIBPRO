...
"background: transparent;"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/icon/Resources/icon/favourites-filled-star-symbol.png"), QSize(), QIcon::Normal, QIcon::Off);
        star2->setIcon(icon1);
...
"color:white;"));
    ...
    {
        Rating->setWindowTitle(QApplication::translate("Rating", "Rate", Q_NULLPTR));
