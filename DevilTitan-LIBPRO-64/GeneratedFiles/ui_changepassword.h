...
"border-radius: 2px;"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/icon/Resources/icon/key (1).png"), QSize(), QIcon::Normal, QIcon::Off);
        btn1->setIcon(icon1);
...
"font-weight:500;"));
    ...
    {
        ChangePassword->setWindowTitle(QApplication::translate("ChangePassword", "Change your password", Q_NULLPTR));
